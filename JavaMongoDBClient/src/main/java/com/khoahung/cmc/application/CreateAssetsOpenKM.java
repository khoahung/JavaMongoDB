...
public class CreateAssetsOpenKM extends Thread{
	...
	public void run(){ 	
		try {
			...
			p5.setValues(Arrays.asList(open.getUser_name()==null?"":open.getUser_name()));
			listP.add(p5);
			...
			p6.setValues(Arrays.asList(open.getReal_name()==null?"":open.getReal_name()));
			listP.add(p6);
			...
			p7.setValues(Arrays.asList(open.getFirst_name()==null?"":open.getFirst_name()));
			listP.add(p7);
			...
			p8.setValues(Arrays.asList(open.getMiddle_name()==null?"":open.getMiddle_name()));
			listP.add(p8);
			...
			p9.setValues(Arrays.asList(open.getLast_name()==null?"":open.getLast_name()));
			listP.add(p9);
			...
			p10.setValues(Arrays.asList(open.getMon_name()==null?"":open.getMon_name()));
			listP.add(p10);
			...
			p11.setValues(Arrays.asList(open.getMobile()==null?"":open.getMobile()));
			listP.add(p11);
			...
			p12.setValues(Arrays.asList(open.getEmail()==null?"":open.getEmail()));
			listP.add(p12);
