package info.magnolia.poc;

/**
 * This class is optional and represents the configuration for the cimb-poc-main module.
 * By exposing simple getter/setter/adder methods, this bean can be configured via content2bean
 * using the properties and node from <tt>config:/modules/cimb-poc-main</tt>.
