...
This package contains:
   ...
   Magnolia Core 6.2.11
   Magnolia empty webapp 6.2.11
   Magnolia empty webapp 6.2.11
   Magnolia Internationalization Framework 6.2.11
   Magnolia JAAS 6.2.11
   magnolia-ldap 1.10.3
   magnolia-license 1.7.4
   Magnolia Link Unfurl Module 1.3.9
   Magnolia Backup Module Project 2.4.1
   Magnolia Mail module 5.5.8
   magnolia-module-rssaggregator 2.6.4
   magnolia-module-soft-locking 3.0.1
   Magnolia Rendering 6.2.11
   Magnolia Templating 6.2.11
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/6.2.11.html
